...
TEXTS = {
    "vi": {
        ...
        "stats_report": (
            ...
            "- Số khách hoạt động hôm nay: `{users_active_today}` người\n"
            "- Tổng lượt dùng hôm nay: `{total_uses_today}` lượt\n"
        ...
        "token_all_dead": "❌ Đã thử nhiều tài khoản nhưng không cái nào hoạt động. Vui lòng thử lại sau!",
    ...
    "en": {
        ...
        "stats_report": (
            ...
            "- Total uses today: `{total_uses_today}` uses\n"
        ...
        "token_all_dead": "❌ Tried multiple accounts but none worked. Please try again later!",
