...
TEXTS = {
    "vi": {
        ...
        "stats_report": (
            ...
            "═══════════════════\n\n"
            "🍪 *Sức khỏe Kho Cookie:*\n"
            "{health_bar} {health_pct}%\n"
            "🟢 Sống: `{cookie_alive}` | 💀 Chết: `{cookie_dead}` | 📦 Tổng: `{cookie_total}`\n"
            "═══════════════════\n\n"
            "👥 *Thống kê User:*\n"
            "- Tổng đăng ký: `{users_total}` người\n"
            "- Hoạt động hôm nay: `{users_active_today}` người\n"
            "- Thành viên mới hôm nay: `{new_users_today}` người\n"
            "═══════════════════\n\n"
            "🎟 *Thống kê Link và TV:*\n"
            "- Tổng all-time: `{total_generated}` lượt\n"
            "- Phát hôm nay: `{links_today}` lượt\n"
            "═══════════════════\n\n"
            "📋 *Chi tiết sử dụng hôm nay:*\n"
            "{active_detail}\n\n"
            "🏆 *Top 5 dùng nhiều nhất:*\n"
            "{top_users}"
        ),
    ...
    "en": {
        ...
        "stats_report": (
            ...
            "🍪 *Cookie Health:*\n"
            "{health_bar} {health_pct}%\n"
            "🟢 Alive: `{cookie_alive}` | 💀 Dead: `{cookie_dead}` | 📦 Total: `{cookie_total}`\n"
            "═══════════════════\n\n"
            "👥 *User Statistics:*\n"
            ...
            "═══════════════════\n\n"
            "🎟 *Link and TV Stats:*\n"
            "- Total all-time: `{total_generated}` uses\n"
            "- Today: `{links_today}` uses\n"
            "═══════════════════\n\n"
